...
class BeautbytTables_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'beautbyt-tables'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'beautbyt-tables'); ?></h2>
            <table cellspacing="1" cellpadding="2"><tbody>
            <tr><td><?php _e('System', 'beautbyt-tables'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'beautbyt-tables'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'beautbyt-tables');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'beautbyt-tables'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'beautbyt-tables');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'beautbyt-tables'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'beautbyt-tables') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'beautbyt-tables');
            case 'false':
                return __('false', 'beautbyt-tables');

            case 'Administrator':
                return __('Administrator', 'beautbyt-tables');
            case 'Editor':
                return __('Editor', 'beautbyt-tables');
            case 'Author':
                return __('Author', 'beautbyt-tables');
            case 'Contributor':
                return __('Contributor', 'beautbyt-tables');
            case 'Subscriber':
                return __('Subscriber', 'beautbyt-tables');
            case 'Anyone':
                return __('Anyone', 'beautbyt-tables');
        }
        return $optionValue;
    }
